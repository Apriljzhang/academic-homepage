...
export const publications: PublicationItem[] = [
  {
    citationHtml:
      'Bai, W., & Zhang, J. (2021). Developing Key Competencies via Formative Assessment in Primary School English Classrooms—Teacher Education Perspective. <em>Journal of Nanjing Xiaozhuang University</em>, (4), 22–27.',
  },
  {
    citationHtml:
  ...
  {
    citationHtml:
      'Ji, T., & Zhang, J. (accepted). Demotivation in English Learning of Chinese Medical Students: Insights from Situated-Expectancy-Value Theory. <em>Acta Psychologica</em>.',
    note: 'Accepted',
  },
  {
    citationHtml:
  ...
  {
    citationHtml:
      'Zheng, Y., Zheng, Y., & Zhang, J. (2021). HSK 试卷架构对1–3 级考生成绩的影响——以英语母语者为例. <em>国际汉语教学研究 International Chinese Language Education</em>, (3), 50–59.',
  },
];
