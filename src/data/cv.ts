...
export const summary =
  'I am Assistant Professor in the School of Education at City University of Macau. I am a researcher in language education and assessment, with a particular interest in how formative and classroom-based assessment can support motivation and learning, especially for young learners and in multilingual settings. My work connects assessment for learning and formative assessment, language education, and technology-assisted learning—especially where generative AI shapes teaching and enquiry. I use mixed-methods designs to link learner experience, motivation, and assessment, and I care about how teachers and researchers navigate these settings in practice. I completed my PhD at the University of Sheffield on formative assessment, motivation, and young English learners in China; before Macau I taught EAP and related programmes at universities in the UK and China. More recently my interests have broadened to assessment for learning in higher education, peer assessment and co-constructed rubrics, and the place of English and Chinese in universities in Macau, alongside how motivation and engagement play out in digital spaces. My published work includes studies on demotivation and expectancy-value perspectives in medical students’ English learning, motivation and learning strategies among HSK test-takers in the UK, formative assessment and key competencies in primary English classrooms, and collaborative work on Chinese language testing and test-taker characteristics. Alongside research, I teach and supervise in teacher education and language education, and I contribute to conferences and professional networks in language assessment across Asia and beyond.';
