...
export const summary =
  'I serve as an Assistant Professor in the School of Education at the City University of Macau, where I look beyond the mechanics of language testing to explore the human side of language pedagogy and educational assessment. My scholarly work is driven by a fundamental belief that Assessment for Learning (AfL) and formative practices should do more than measure progress. Instead, I am interested in how these tools can be used both within and beyond the classroom to foster a genuine sense of well-being and engagement, ensuring that the educational journey is as fulfilling as the final result.\n\nMy path to this point has been shaped by a transition from the practical world of English for Academic Purposes (EAP) in the UK and China to my current role as a teacher-researcher. This journey has allowed me to remain a lifelong advocate for the student experience. Starting with my doctoral research at the University of Sheffield, where I examined the motivational dynamics of young learners, my work has grown into a broader portfolio. I now explore how we can empower students through GenAI and peer-mediated feedback and co-constructed rubrics, always seeking to understand the lived reality of those navigating multilingual settings.\n\nIn my current projects, I am increasingly focused on the evolving role of technology-assisted education. I am curious about how GenAI and informal digital tools can be integrated thoughtfully into our teaching and assessment to support rather than replace human enquiry. Whether I am investigating the place of English within young learners or looking at how emotions plays out in digital spaces, my goal is to bridge the gap between traditional structures and the needs of the modern learner. By bringing an empathetic and reflective lens to my research, I hope to contribute to an academic landscape where every student feels supported to reach their full potential.';
...
export const researchFramework = {
  ...
  what:
    'Substantively, the portfolio turns on how assessment for learning and formative practices shape language classrooms; how English and Chinese figure in multilingual education, including universities in Macau; how motivation, social–emotional learning, and learner experience unfold from early years through postgraduate study; how generative AI and other technologies mediate language learning, testing, and research practice; and how pedagogy, tools, and vocabulary development support teachers and learners in those environments. A single study often braids several of these strands rather than isolating one. The Research themes page uses five headings for clarity, but the boundaries are porous by design.',
